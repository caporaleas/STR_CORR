function [corr_acrossROIs_GM,corr_acrossROIs_WM] = STR_CORR_09_corr_median_medians_acrossROIs(median_R1_GM,median_R1_WM,median_diff_GM,median_diff_WM,parameters,outpath,confidence_bounds)
...
corr_acrossROIs_GM = zeros(N_par-1,2);
corr_acrossROIs_WM = zeros(N_par-1,2);

plotname_GM = 'Scatterplot_GM_diffpar_vs_R1_acrossROIs';
plotname_WM = 'Scatterplot_WM_diffpar_vs_R1_acrossROIs';

median_median_R1_GM = median(median_R1_GM,1,'omitnan');
median_median_diff_GM = median(median_diff_GM,1,'omitnan');
% median_median_R1_GM = mean(median_R1_GM,1,'omitnan');
% median_median_diff_GM = mean(median_diff_GM,1,'omitnan');
...
for pp = 1 : N_par-1
    ...
    corr_acrossROIs_GM(pp,1) = r(2);
    corr_acrossROIs_GM(pp,2) = p(2);
