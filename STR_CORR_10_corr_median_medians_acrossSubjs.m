function [corr_acrossSubjs_GM,corr_acrossSubjs_WM] = STR_CORR_10_corr_median_medians_acrossSubjs(median_R1_GM,median_R1_WM,median_diff_GM,median_diff_WM,parameters,outpath,confidence_bounds)
...
plotname_GM = 'Scatterplot_GM_diffpar_vs_R1_acrossSubjs';
plotname_WM = 'Scatterplot_WM_diffpar_vs_R1_acrossSubjs';

median_median_R1_GM = median(median_R1_GM,2,'omitnan');
median_median_diff_GM = median(median_diff_GM,2,'omitnan');

mad_median_R1_GM = mad(median_R1_GM,1,2);
mad_median_diff_GM = mad(median_diff_GM,1,2);
...
SE_R1_GM = mad_median_R1_GM.*1.4826./sqrt(N_GM_ROIs);
SE_diff_GM = mad_median_diff_GM.*1.4826./sqrt(N_GM_ROIs);
